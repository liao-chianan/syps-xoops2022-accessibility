...
define('_MI_TADRSS_DESC', 'Adding RSS/Atom syndicated content inside your XOOPS Site.');
define('_MI_TADRSS_ADMENU1', 'Admin');
define('_MI_TADRSS_BNAME1', 'RSS News');
define('_MI_TADRSS_BDESC1', 'List RSS News');
define('_MI_TADRSS_SHOW_NUM', 'News number');
...
//help
define('_MI_TADRSS_HELP_OVERVIEW', 'Overview');
