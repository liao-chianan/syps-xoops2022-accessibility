...
define('_MI_TADNEWS_NAME', 'Tad News');
define('_MI_TADNEWS_DESC', 'An easy to use News module');
...
define('_MI_TADNEWS_TITLE1', '<span style="font-weight: bold;">News numbers in each page?</span>');
define('_MI_TADNEWS_DESC1', 'Set the news numbers in each page');

define('_MI_TADNEWS_SHOW_MODE', '<span style="font-weight: bold;">Performing method of Index</span>');
...
define('_MI_TADNEWS_CATE_SHOW_MODE', '<span style="font-weight: bold;">Performing method in single category</span>');
...
define('_MI_TADNEWS_PIC_WIDTH', '<span style="font-weight: bold;">Width of attachment image</span>');
define('_MI_TADNEWS_PIC_WIDTH_DESC', 'Default width of the image files as attachment (pixels)');

define('_MI_TADNEWS_THUMB_WIDTH', '<span style="font-weight: bold;">Width of attachment thumbnail</span>');
