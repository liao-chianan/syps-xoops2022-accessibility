...
define("_AM_WEIGHT", "區塊排序");
define("_AM_VISIBLEIN", "是否啟用");
define("_AM_BCACHETIME", "最後更新時間");
define("_AM_ACTION", "動作");
define("_MD_AM_ADGS", "權限設定");
define("_AM_ACTIVERIGHTS", "觀看權限");
define("_AM_ACCESSRIGHTS", "寫入權限");
