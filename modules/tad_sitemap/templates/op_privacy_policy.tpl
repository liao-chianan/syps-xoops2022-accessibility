<h2>隱私權保護政策</h2>
<div style="margin: 10px auto; line-height: 2rem; font-weight: normal">
  <p>
    非常歡迎您光臨「<{$xoops_sitename}>」（以下簡稱本網站），為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
  </p>
