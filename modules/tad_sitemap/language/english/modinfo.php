...
define('_MI_TADSITEMA_NAME', 'Site Map');
define('_MI_TADSITEMA_AUTHOR', 'Tad (tad0616@gmail.com)');
define('_MI_TADSITEMA_CREDITS', '');
define('_MI_TADSITEMA_DESC', 'Site Map');
...
//help
define('_MI_TADSITEMA_HELP_OVERVIEW', 'Overview');
