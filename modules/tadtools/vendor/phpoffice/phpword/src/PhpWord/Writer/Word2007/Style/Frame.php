...
class Frame extends AbstractStyle
{
    ...
    public function write()
    {
        ...
        $zIndices = [FrameStyle::WRAP_INFRONT => PHP_INT_MAX, FrameStyle::WRAP_BEHIND => -PHP_INT_MAX];
        ...
        $wrap = $style->getWrap();
        if (null !== $wrap && isset($zIndices[$wrap])) {
