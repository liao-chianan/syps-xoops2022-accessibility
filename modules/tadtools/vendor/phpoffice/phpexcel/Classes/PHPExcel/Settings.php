...
class PHPExcel_Settings
{
    ...
    {
        if ((self::PCLZIP === $zipClass) ||
            (self::ZIPARCHIVE === $zipClass)) {
    ...
    {
        if (null === $options && defined('LIBXML_DTDLOAD')) {
    ...
    {
        if (null === self::$libXmlLoaderOptions && defined('LIBXML_DTDLOAD')) {
            self::setLibXmlLoaderOptions(LIBXML_DTDLOAD | LIBXML_DTDATTR);
        } elseif (null === self::$libXmlLoaderOptions) {
