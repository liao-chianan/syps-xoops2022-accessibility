...
<fieldset class="pad10">
    ...
    <form action="user.php" method="post">
        <label for="uname"><{$lang_username}></label> <input type="text" id="uname" title="uname" name="uname" placeholder="<{$smarty.const.THEME_LOGIN}>" size="26" maxlength="25" value=""/><br><br>
        <label for="pass"><{$lang_password}></label> <input type="password" id="pass" title="pass" name="pass" placeholder="<{$smarty.const.THEME_PASS}>" size="21" maxlength="32"/><br><br>
        ...
        <input type="submit" title="<{$lang_login}>" value="<{$lang_login}>"/>
    </form>
    <br>
    <a name="lost">&nbsp;</a>
