...
class PageBar
{
    ...
    public function makeBootStrapBar($url_page = 'none')
    {
        ...
        if ($this->current <= 1) {
            ...
            $bar_left = "<li class='page-item disabled'><a class='page-link disabled' href='#'>". _TAD_BACK_PAGE ."</a></li>";
            $bar_first = "<li class='page-item disabled'><a class='page-link disabled' href='#'>". _TAD_FIRST_PAGE ."</a></li>";
        } else {
            $i = $this->current - 1;
            $bar_left = "<li class='page-item'><a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}={$i}{$loadtime}' title='" . _TAD_BACK_PAGE . "'>". _TAD_BACK_PAGE ."</a></li>";
            $bar_first = "<li class='page-item'><a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}=1{$loadtime}' title='" . _TAD_FIRST_PAGE . "' >". _TAD_FIRST_PAGE ."</a></li>";
        }

        // 往後跳一頁
        if ($this->current >= $this->pTotal) {
            //$bar_right=$bar_last="";
            $bar_right = "<li class='page-item disabled'><a class='page-link disabled' href='#' title='" . _TAD_NEXT_PAGE ."'>". _TAD_NEXT_PAGE ."</a></li>";
            $bar_last = "<li class='page-item disabled'><a class='page-link disabled' href='#' title='" . _TAD_LAST_PAGE . "' >". _TAD_LAST_PAGE ."</a></li>";
        } else {
            $i = $this->current + 1;
            $bar_right = "<li class='page-item'><a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}={$i}{$loadtime}' title='" . _TAD_NEXT_PAGE . "'>" ._TAD_NEXT_PAGE."</a></li>";
            $bar_last = "<li class='page-item'><a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}={$this->pTotal}{$loadtime}' title='" . _TAD_LAST_PAGE . "' >"._TAD_LAST_PAGE."</a></li>";
        }
