    ...
    <form action="blocks.php" id="myForm" method="post" role="form" class="form-horizontal">
        <div class="alert alert-success">
            <div class="form-group row mb-3">
                ...
                <label class="col-sm-2 control-label col-form-label text-sm-right"><{$smarty.const._MD_TAD_BLOCKS_LOGO_BORDER_SIZE}></label>
                <div class="col-sm-2">
                    <input type="number" class="form-control validate[required]" name="TDC[border_size]" id="border_size" placeholder="<{$smarty.const._MD_TAD_BLOCKS_LOGO_BORDER_SIZE}>" value="<{$border_size}>">
                </div>
                <label class="col-sm-2 control-label col-form-label text-sm-right"><{$smarty.const._MD_TAD_BLOCKS_LOGO_SHADOW_SIZE}></label>
                <div class="col-sm-2">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-2">
                    <input type="text" name="TDC[border_color]" class="form-control color-picker" value="<{$border_color}>" id="border_color" data-hex="true">
                </div>
                <label class="col-sm-2 control-label col-form-label text-sm-right"><{$smarty.const._MD_TAD_BLOCKS_LOGO_SHADOW_COLOR}></label>
                <div class="col-sm-2">
                    <input type="text" name="TDC[shadow_color]" class="col-sm-10 form-control color-picker" value="<{$shadow_color}>" id="shadow_color" data-hex="true">
                </div>
            </div>
            ...
            <div class="form-group row mb-3">
                ...
                <label class="col-sm-2 control-label col-form-label text-sm-right"><{$smarty.const._MD_TAD_BLOCKS_LOGO_SHADOW_X}></label>
                <div class="col-sm-2">
                    <input type="number" name="TDC[shadow_x]" class="col-sm-10 form-control" value="<{$shadow_x}>" id="shadow_x">
                </div>
                <label class="col-sm-2 control-label col-form-label text-sm-right"><{$smarty.const._MD_TAD_BLOCKS_LOGO_SHADOW_Y}></label>
                <div class="col-sm-2">
                    <input type="number" name="TDC[shadow_y]" class="col-sm-10 form-control" value="<{$shadow_y}>" id="shadow_y">
                </div>
            </div>
        </div>
