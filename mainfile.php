...
if (!defined('XOOPS_MAINFILE_INCLUDED')) {
    ...
    // echo "<div>XOOPS_URL:" . XOOPS_URL . "</div>";
    // echo "<div>XOOPS_ROOT_PATH:" . XOOPS_ROOT_PATH . "</div>";
    // echo "<div>XOOPS_PATH:" . XOOPS_TRUST_PATH . "</div>";
    // echo "<div>XOOPS_VAR_PATH:" . XOOPS_VAR_PATH . "</div>";
    // echo "<div>XOOPS_TRUST_PATH:" . XOOPS_TRUST_PATH . "</div>";
    // echo "<div>\$_SERVER[PHP_SELF]:" . $_SERVER['PHP_SELF'] . "</div>";
    // echo "<div>\$_SERVER[SCRIPT_FILENAME]:" . $_SERVER["SCRIPT_FILENAME"] . "</div>";
    // exit;
